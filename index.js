...
import { setupTownshipApis } from './township.js'
...
import { setupMockPropertyDetails } from "./mockPropertyDetails.js";
dotenv.config();
const app = express();
...
setupMockPropertyDetails(app, db);
...
// ------------------- Setup Township Hierarchy APIs -------------------
setupTownshipApis(app, db, upload);
